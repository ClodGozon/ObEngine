    ...
    void LoadAnimation(kaguya::State* lua)
    {
        (*lua)["obe"]["Animation"].setClass(
            kaguya::UserdataMetatable<Animation::Animation>()
                .addFunction("applyParameters",
                             &Animation::Animation::applyParameters)
                .addFunction("getAllAnimationGroupName",
                             &Animation::Animation::getAllAnimationGroupName)
                .addFunction("getAnimationDelay",
                             &Animation::Animation::getAnimationDelay)
                .addFunction("getAnimationGroup",
                             &Animation::Animation::getAnimationGroup)
                .addFunction("getAnimationName",
                             &Animation::Animation::getAnimationName)
                .addFunction("getAnimationPlayMode",
                             &Animation::Animation::getAnimationPlayMode)
                .addFunction("getAnimationStatus",
                             &Animation::Animation::getAnimationStatus)
                .addFunction("getCalledAnimation",
                             &Animation::Animation::getCalledAnimation)
                ...
                .addFunction("getSpriteOffset",
                             &Animation::Animation::getSpriteOffset)
                .addFunction("getTexture", &Animation::Animation::getTexture)
                .addFunction("getTextureAtIndex",
                             &Animation::Animation::getTextureAtIndex)
                .addFunction("isAnimationOver",
                             &Animation::Animation::isAnimationOver)
                .addFunction("loadAnimation",
    ...
    void LoadAnimationGroup(kaguya::State* lua)
    {
        (*lua)["obe"]["AnimationGroup"].setClass(
            kaguya::UserdataMetatable<Animation::AnimationGroup>()
                ...
                .addFunction("forcePrevious",
                             &Animation::AnimationGroup::forcePrevious)
                .addFunction("getGroupDelay",
                             &Animation::AnimationGroup::getGroupDelay)
                .addFunction("getGroupIndex",
                             &Animation::AnimationGroup::getGroupIndex)
                .addFunction("getGroupName",
                             &Animation::AnimationGroup::getGroupName)
                .addFunction("getGroupSize",
                             &Animation::AnimationGroup::getGroupSize)
                .addFunction("getTexture",
                             &Animation::AnimationGroup::getTexture)
                .addFunction("isGroupOver",
                             &Animation::AnimationGroup::isGroupOver)
                .addFunction("next", &Animation::AnimationGroup::next)
                .addFunction("previous", &Animation::AnimationGroup::previous)
                .addFunction("pushTexture",
                             &Animation::AnimationGroup::pushTexture)
                ...
                .addFunction("setGroupDelay",
                             &Animation::AnimationGroup::setGroupDelay)
                .addFunction("setGroupLoop",
                             &Animation::AnimationGroup::setGroupLoop)
                .addFunction("update", &Animation::AnimationGroup::update));
    }

    KAGUYA_MEMBER_FUNCTION_OVERLOADS(Animator_setTarget_wrapper,
                                     Animation::Animator, setTarget, 1, 2);
    void LoadAnimator(kaguya::State* lua)
    {
        (*lua)["obe"]["Animator"].setClass(
            kaguya::UserdataMetatable<Animation::Animator>()
                ...
                .addFunction("getTextureAtKey",
                             &Animation::Animator::getTextureAtKey)
                .addFunction("loadAnimator", &Animation::Animator::loadAnimator)
                .addFunction("setKey", &Animation::Animator::setKey)
                .addOverloadedFunctions(
                    "setPath",
                    static_cast<void (Animation::Animator::*)(
                        const System::Path&)>(&Animation::Animator::setPath),
                    static_cast<void (Animation::Animator::*)(
                        const std::string&)>(&Animation::Animator::setPath))
